...
import 'package:music_app/ui/audio_notification/SeekBar.dart';
import 'package:rxdart/rxdart.dart';

class AudioNotification extends StatelessWidget {
  const AudioNotification({super.key});
          ...
          children: [
            ...
            StreamBuilder<MediaState>(
              ...
              builder: (context, snapshot) {
                ...
                //     final pos = newPosition * (mediaState?.mediaItem?.duration?.inSeconds ?? 0);
                //     audioHandler.seek(Duration(seconds: pos.round()));
                //   },
                // );
              },
            ),
